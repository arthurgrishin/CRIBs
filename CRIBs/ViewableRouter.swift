...
open class ViewableRouter<DependencyType, InteractorType, ViewControllerType>: Router<DependencyType, InteractorType>, ViewableRouting {
    ...
    public init(dependency: DependencyType, interactor: InteractorType, viewController: ViewControllerType) {
